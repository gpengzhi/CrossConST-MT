...
@dataclass
class LabelSmoothedCrossEntropyCriterionWithCrossConSTConfig(FairseqDataclass):
...
@register_criterion(
    "label_smoothed_cross_entropy_with_crossconst", dataclass=LabelSmoothedCrossEntropyCriterionWithCrossConSTConfig
)
class LabelSmoothedCrossEntropyWithCrossConSTCriterion(FairseqCriterion):
    def __init__(
            self,
            task,
            sentence_avg,
            ...
            src_tokens_list.append(
                torch.nn.functional.pad(
                    torch.nn.functional.pad(
                        ...
                        (1, 0),
                        value=sample['net_input']['src_tokens'][i][-sample["net_input"]["src_lengths"][i].item()].item()
                    ),
